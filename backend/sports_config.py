...
ALIAS_MAP = {
    ...
    "philrowe": ["philiprowe"],
    "philiprowe": ["philrowe"],
    "sergheispivac": ["sergeispivak", "sergeyspivak", "sergeispivac", "sergheispivak"],
    "sergeispivak": ["sergheispivac", "sergeyspivak", "sergeispivac", "sergheispivak"],
    "sergeyspivak": ["sergheispivac", "sergeispivak", "sergeispivac", "sergheispivak"],
    "sergeispivac": ["sergheispivac", "sergeispivak", "sergeyspivak", "sergheispivak"],
    "sergheispivak": ["sergheispivac", "sergeispivak", "sergeyspivak", "sergeispivac"],
    ...
    # --- EPL (English Premier League) --- FULLY TRANSITIVE
    "manchesterunited": ["manutd", "manunited", "manu"],
    "manutd": ["manchesterunited", "manunited", "manu"],
    "manunited": ["manchesterunited", "manutd", "manu"],
    "manchestercity": ["mancity", "mcfc"],
    "mancity": ["manchestercity", "mcfc"],
    "tottenhamhotspur": ["tottenham", "spursfc", "thfc", "spurs"],
    "tottenham": ["tottenhamhotspur", "spursfc", "thfc", "spurs"],
    "spurs": ["tottenham", "tottenhamhotspur", "spursfc", "thfc"],
    ...
    "nottmforest": ["nottinghamforest", "nottsforest", "nffc", "forest"],
    "forest": ["nottinghamforest", "nottmforest", "nottsforest", "nffc"],
}
